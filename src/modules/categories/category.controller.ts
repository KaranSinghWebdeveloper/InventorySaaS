...
export class CategoryController {
  ...
  getById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const category = await this.categoryService.getById(req.user!.businessId, req.params.id as string);
  ...
  update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const category = await this.categoryService.update(req.user!.businessId, req.params.id as string, req.body);
  ...
  delete = async (req: Request, res: Response, next: NextFunction) => {
    try {
      await this.categoryService.delete(req.user!.businessId, req.params.id as string);
