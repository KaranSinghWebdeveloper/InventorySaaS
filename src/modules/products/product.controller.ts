...
export class ProductController {
  ...
  getById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const product = await this.productService.getById(req.user!.businessId, req.params.id as string);
  ...
  update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const product = await this.productService.update(req.user!.businessId, req.params.id as string, req.body);
  ...
  delete = async (req: Request, res: Response, next: NextFunction) => {
    try {
      await this.productService.delete(req.user!.businessId, req.params.id as string);
